    ...
    public static class TroopDataFactory
    {
        ...
        public static void CreateAll()
        {
            ...
            Create("Infantry", "Balanced unit. Fights on the front line.",
                ...
                CostEntryHelper.Costs(ResourceType.Food, 5, ResourceType.Metal, 3));
            ...
            Create("Sniper", "Long range damage. Weak in close combat.",
                ...
                CostEntryHelper.Costs(ResourceType.Food, 8, ResourceType.Metal, 5));
            ...
            Create("Heavy", "Tank unit. High HP, slow movement.",
                ...
                CostEntryHelper.Costs(ResourceType.Food, 12, ResourceType.Metal, 10));
            ...
            Create("Scout", "Fast recon unit. Stealthy movement.",
                ...
                CostEntryHelper.Costs(ResourceType.Food, 3, ResourceType.Metal, 2));
            ...
            Create("Engineer", "Support unit. Repair and trap building.",
                ...
                CostEntryHelper.Costs(ResourceType.Food, 10, ResourceType.Metal, 8));
