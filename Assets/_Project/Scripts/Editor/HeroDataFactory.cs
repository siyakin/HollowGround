...
namespace HollowGround.Editor
{
    ...
    {
        [MenuItem("Assets/Create/HollowGround/HeroData/Commander")]
        public static void CreateCommander() => CreateHeroData("Commander", "Born leader. Boosts army attack and defense.",
        ...
        [MenuItem("Assets/Create/HollowGround/HeroData/Warrior")]
        public static void CreateWarrior() => CreateHeroData("Warrior", "Frontline fighter. High HP and defense.",
            HeroRole.Warrior, HeroRarity.Common, 300, 15, 20, 2f,
            "Iron Skin", "Takes 15% less damage", 0.15f,
            "Shield Bash", "Stuns enemies briefly", 20f,
            0.03f, 0.08f, 100);

        [MenuItem("Assets/Create/HollowGround/HeroData/Ranger")]
        public static void CreateRanger() => CreateHeroData("Ranger", "Long range specialist. High attack power.",
        ...
        [MenuItem("Assets/Create/HollowGround/HeroData/Engineer Hero")]
        public static void CreateEngineer() => CreateHeroData("Engineer", "Support specialist. Boosts defense and healing.",
        ...
        [MenuItem("Assets/Create/HollowGround/HeroData/Scout")]
        public static void CreateScout() => CreateHeroData("Scout", "Recon expert. Increases expedition speed.",
        ...
        private static void CreateHeroData(
            ...
            int summonCost)
        {
            ...
            string path = EditorUtility.SaveFilePanelInProject(
                "Save Hero Data", name, "asset", "Save hero data",
                "Assets/_Project/ScriptableObjects/Heroes");
