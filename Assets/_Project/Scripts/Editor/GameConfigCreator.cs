...
namespace HollowGround.Editor
{
    public static class GameConfigCreator
    {
        ...
        public static void Create()
        {
            ...
            config.WaterNormalStrength = 0.3f;
            config.WaterFresnelPower = 2.5f;
            config.WaterDepthFactor = 1.5f;
            config.WaterRefractionStrength = 0.01f;
            config.WaterOpacity = 0.85f;
            config.WaterBaseColor = new Color(0.04f, 0.12f, 0.30f, 0.90f);
            config.WaterShallowColor = new Color(0.10f, 0.50f, 0.60f, 0.60f);
            config.WaterFoamColor = new Color(0.85f, 0.92f, 0.95f, 1.00f);
